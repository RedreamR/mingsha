...
public class Menu_CreateScenario_Events_AddNewOutcome extends Menu {
   ...
   public void updateLang() {
      ...
      this.getMenuElem(7)
         .setTextE(
            CFG.lang.get("WhitePeace")
               + " "
               + CFG.lang.get("OR")
               + " -> "
               + CFG.lang.get("AllCivilizations")
               + ": "
               + CFG.lang.get("AtWar")
               + " -> "
               + CFG.lang.get("WhitePeace")
      ...
      this.getMenuElem(9)
         .setTextE(CFG.lang.get("AddCivilization") + " | " + CFG.lang.get("OR") + " | " + CFG.lang.get("CreateAVassal") + " - " + CFG.lang.get("OutComeAddCiv"));
      ...
      this.getMenuElem(66)
         .setTextE(CFG.lang.get("GlobalEvent") + ": " + CFG.lang.get("UpdateEconomyPercentage") + ": X% - " + CFG.lang.get("AllCivilizations"));
      ...
      this.getMenuElem(73).setTextE("Counter SET (expr)");
      this.getMenuElem(74).setTextE("Counter +");
   ...
   public final void actionEL(int iID) {
      switch (iID) {
         case 0:
            ...
            break;
         case 1:
            CFG.eventsManager.createScenarioEvents.lDecisions.get(CFG.eventsManager.createEvent_EditTriggerID)
               .lOutcomes
            ...
            break;
         case 2:
            CFG.eventsManager.createScenarioEvents.lDecisions.get(CFG.eventsManager.createEvent_EditTriggerID).lOutcomes.add(new Event_Outcome_ChangeOwner());
            CFG.eventsManager.createEvent_EditConditionID = CFG.eventsManager.createScenarioEvents.lDecisions.get(CFG.eventsManager.createEvent_EditTriggerID)
                  .lOutcomes
                  .size()
               - 1;
            ...
            break;
         case 3:
            CFG.eventsManager.createScenarioEvents.lDecisions.get(CFG.eventsManager.createEvent_EditTriggerID).lOutcomes.add(new Event_Outcome_Occupy());
            CFG.eventsManager.createEvent_EditConditionID = CFG.eventsManager.createScenarioEvents.lDecisions.get(CFG.eventsManager.createEvent_EditTriggerID)
                  .lOutcomes
                  .size()
               - 1;
            ...
            break;
         case 4:
            CFG.eventsManager.createScenarioEvents.lDecisions.get(CFG.eventsManager.createEvent_EditTriggerID).lOutcomes.add(new Event_Outcome_AddCore());
            CFG.eventsManager.createEvent_EditConditionID = CFG.eventsManager.createScenarioEvents.lDecisions.get(CFG.eventsManager.createEvent_EditTriggerID)
                  .lOutcomes
                  .size()
               - 1;
            ...
            break;
         case 5:
            CFG.eventsManager.createScenarioEvents.lDecisions.get(CFG.eventsManager.createEvent_EditTriggerID).lOutcomes.add(new Event_Outcome_RemoveCore());
            CFG.eventsManager.createEvent_EditConditionID = CFG.eventsManager.createScenarioEvents.lDecisions.get(CFG.eventsManager.createEvent_EditTriggerID)
                  .lOutcomes
                  .size()
               - 1;
            ...
            break;
         case 6:
            CFG.eventsManager.createScenarioEvents.lDecisions.get(CFG.eventsManager.createEvent_EditTriggerID).lOutcomes.add(new Event_Outcome_DeclareWar());
            CFG.eventsManager.createEvent_EditConditionID = CFG.eventsManager.createScenarioEvents.lDecisions.get(CFG.eventsManager.createEvent_EditTriggerID)
                  .lOutcomes
                  .size()
               - 1;
            ...
            break;
         case 7:
            CFG.eventsManager.createScenarioEvents.lDecisions.get(CFG.eventsManager.createEvent_EditTriggerID).lOutcomes.add(new Event_Outcome_WhitePeace());
            CFG.eventsManager.createEvent_EditConditionID = CFG.eventsManager.createScenarioEvents.lDecisions.get(CFG.eventsManager.createEvent_EditTriggerID)
                  .lOutcomes
                  .size()
               - 1;
         ...
         case 8:
            ...
            break;
         case 9:
            CFG.eventsManager.createScenarioEvents.lDecisions.get(CFG.eventsManager.createEvent_EditTriggerID).lOutcomes.add(new Event_Outcome_CreateVassal());
            CFG.eventsManager.createEvent_EditConditionID = CFG.eventsManager.createScenarioEvents.lDecisions.get(CFG.eventsManager.createEvent_EditTriggerID)
                  .lOutcomes
                  .size()
               - 1;
         ...
         case 10:
            ...
            break;
         case 11:
            CFG.eventsManager.createScenarioEvents.lDecisions.get(CFG.eventsManager.createEvent_EditTriggerID).lOutcomes.add(new Event_Outcome_JoinAlliance());
            CFG.eventsManager.createEvent_EditConditionID = CFG.eventsManager.createScenarioEvents.lDecisions.get(CFG.eventsManager.createEvent_EditTriggerID)
                  .lOutcomes
                  .size()
               - 1;
            ...
            break;
         case 12:
            CFG.eventsManager.createScenarioEvents.lDecisions.get(CFG.eventsManager.createEvent_EditTriggerID).lOutcomes.add(new Event_Outcome_LeaveAlliance());
            CFG.eventsManager.createEvent_EditConditionID = CFG.eventsManager.createScenarioEvents.lDecisions.get(CFG.eventsManager.createEvent_EditTriggerID)
                  .lOutcomes
                  .size()
               - 1;
            ...
            break;
         case 13:
            CFG.eventsManager.createScenarioEvents.lDecisions.get(CFG.eventsManager.createEvent_EditTriggerID).lOutcomes.add(new Event_Outcome_JoinUnion());
            CFG.eventsManager.createEvent_EditConditionID = CFG.eventsManager.createScenarioEvents.lDecisions.get(CFG.eventsManager.createEvent_EditTriggerID)
                  .lOutcomes
                  .size()
               - 1;
         ...
         case 14:
            ...
            break;
         case 15:
            CFG.eventsManager.createScenarioEvents.lDecisions.get(CFG.eventsManager.createEvent_EditTriggerID).lOutcomes.add(new Event_Outcome_NonAggression());
            CFG.eventsManager.createEvent_EditConditionID = CFG.eventsManager.createScenarioEvents.lDecisions.get(CFG.eventsManager.createEvent_EditTriggerID)
                  .lOutcomes
                  .size()
               - 1;
            ...
            break;
         case 16:
            CFG.eventsManager.createScenarioEvents.lDecisions.get(CFG.eventsManager.createEvent_EditTriggerID).lOutcomes.add(new Event_Outcome_DefensivePact());
            CFG.eventsManager.createEvent_EditConditionID = CFG.eventsManager.createScenarioEvents.lDecisions.get(CFG.eventsManager.createEvent_EditTriggerID)
                  .lOutcomes
                  .size()
               - 1;
            ...
            break;
         case 17:
            CFG.eventsManager.createScenarioEvents.lDecisions.get(CFG.eventsManager.createEvent_EditTriggerID).lOutcomes.add(new Event_Outcome_Independence());
            CFG.eventsManager.createEvent_EditConditionID = CFG.eventsManager.createScenarioEvents.lDecisions.get(CFG.eventsManager.createEvent_EditTriggerID)
                  .lOutcomes
                  .size()
               - 1;
         ...
         case 18:
            ...
            break;
         case 19:
            CFG.eventsManager.createScenarioEvents.lDecisions.get(CFG.eventsManager.createEvent_EditTriggerID).lOutcomes.add(new Event_Outcome_MoveCapital());
            CFG.eventsManager.createEvent_EditConditionID = CFG.eventsManager.createScenarioEvents.lDecisions.get(CFG.eventsManager.createEvent_EditTriggerID)
                  .lOutcomes
                  .size()
               - 1;
         ...
         case 20:
            ...
            break;
         case 21:
            CFG.eventsManager.createScenarioEvents.lDecisions.get(CFG.eventsManager.createEvent_EditTriggerID).lOutcomes.add(new Event_Outcome_AddArmy());
            CFG.eventsManager.createEvent_EditConditionID = CFG.eventsManager.createScenarioEvents.lDecisions.get(CFG.eventsManager.createEvent_EditTriggerID)
                  .lOutcomes
                  .size()
               - 1;
         ...
         case 24:
            ...
            break;
         case 25:
            CFG.eventsManager.createScenarioEvents.lDecisions.get(CFG.eventsManager.createEvent_EditTriggerID).lOutcomes.add(new Event_Outcome_UpdateEconomy());
            CFG.eventsManager.createEvent_EditConditionID = CFG.eventsManager.createScenarioEvents.lDecisions.get(CFG.eventsManager.createEvent_EditTriggerID)
                  .lOutcomes
                  .size()
               - 1;
         ...
         case 27:
            ...
            break;
         case 28:
            CFG.eventsManager.createScenarioEvents.lDecisions.get(CFG.eventsManager.createEvent_EditTriggerID).lOutcomes.add(new Event_Outcome_TechLevel());
            CFG.eventsManager.createEvent_EditConditionID = CFG.eventsManager.createScenarioEvents.lDecisions.get(CFG.eventsManager.createEvent_EditTriggerID)
                  .lOutcomes
                  .size()
               - 1;
            ...
            break;
         case 29:
            CFG.eventsManager.createScenarioEvents.lDecisions.get(CFG.eventsManager.createEvent_EditTriggerID).lOutcomes.add(new Event_Outcome_DevLevel());
            CFG.eventsManager.createEvent_EditConditionID = CFG.eventsManager.createScenarioEvents.lDecisions.get(CFG.eventsManager.createEvent_EditTriggerID)
                  .lOutcomes
                  .size()
               - 1;
         ...
         case 31:
            ...
            break;
         case 32:
            CFG.eventsManager.createScenarioEvents.lDecisions.get(CFG.eventsManager.createEvent_EditTriggerID).lOutcomes.add(new Event_Outcome_Money());
            CFG.eventsManager.createEvent_EditConditionID = CFG.eventsManager.createScenarioEvents.lDecisions.get(CFG.eventsManager.createEvent_EditTriggerID)
                  .lOutcomes
                  .size()
               - 1;
         ...
         case 34:
            ...
            break;
         case 35:
            CFG.eventsManager.createScenarioEvents.lDecisions.get(CFG.eventsManager.createEvent_EditTriggerID).lOutcomes.add(new Event_Outcome_Wasteland());
            CFG.eventsManager.createEvent_EditConditionID = CFG.eventsManager.createScenarioEvents.lDecisions.get(CFG.eventsManager.createEvent_EditTriggerID)
                  .lOutcomes
                  .size()
               - 1;
            ...
            break;
         case 36:
            CFG.eventsManager.createScenarioEvents.lDecisions.get(CFG.eventsManager.createEvent_EditTriggerID).lOutcomes.add(new Event_Outcome_ChangeLeader());
            CFG.eventsManager.createEvent_EditConditionID = CFG.eventsManager.createScenarioEvents.lDecisions.get(CFG.eventsManager.createEvent_EditTriggerID)
                  .lOutcomes
                  .size()
               - 1;
         ...
         case 37:
            CFG.eventsManager.createScenarioEvents.lDecisions.get(CFG.eventsManager.createEvent_EditTriggerID)
               .lOutcomes
               .add(new Event_Outcome_ChangeReligion());
            CFG.eventsManager.createEvent_EditConditionID = CFG.eventsManager.createScenarioEvents.lDecisions.get(CFG.eventsManager.createEvent_EditTriggerID)
                  .lOutcomes
                  .size()
               - 1;
         ...
         case 38:
            CFG.eventsManager.createScenarioEvents.lDecisions.get(CFG.eventsManager.createEvent_EditTriggerID)
               .lOutcomes
               .add(new Event_Outcome_FightCoalition());
            CFG.eventsManager.createEvent_EditConditionID = CFG.eventsManager.createScenarioEvents.lDecisions.get(CFG.eventsManager.createEvent_EditTriggerID)
                  .lOutcomes
                  .size()
               - 1;
            ...
            break;
         case 39:
            CFG.eventsManager.createScenarioEvents.lDecisions.get(CFG.eventsManager.createEvent_EditTriggerID).lOutcomes.add(new Event_Outcome_BuildBuilding());
            CFG.eventsManager.createEvent_EditConditionID = CFG.eventsManager.createScenarioEvents.lDecisions.get(CFG.eventsManager.createEvent_EditTriggerID)
                  .lOutcomes
                  .size()
               - 1;
         ...
         case 40:
            CFG.eventsManager.createScenarioEvents.lDecisions.get(CFG.eventsManager.createEvent_EditTriggerID)
               .lOutcomes
               .add(new Event_Outcome_BuildingDestroy());
            CFG.eventsManager.createEvent_EditConditionID = CFG.eventsManager.createScenarioEvents.lDecisions.get(CFG.eventsManager.createEvent_EditTriggerID)
                  .lOutcomes
                  .size()
               - 1;
            ...
            break;
         case 41:
            CFG.eventsManager.createScenarioEvents.lDecisions.get(CFG.eventsManager.createEvent_EditTriggerID).lOutcomes.add(new Event_Outcome_NukesChange());
            CFG.eventsManager.createEvent_EditConditionID = CFG.eventsManager.createScenarioEvents.lDecisions.get(CFG.eventsManager.createEvent_EditTriggerID)
                  .lOutcomes
                  .size()
               - 1;
         ...
         case 42:
            CFG.eventsManager.createScenarioEvents.lDecisions.get(CFG.eventsManager.createEvent_EditTriggerID)
               .lOutcomes
               .add(new Event_Outcome_NukesProvinces());
            CFG.eventsManager.createEvent_EditConditionID = CFG.eventsManager.createScenarioEvents.lDecisions.get(CFG.eventsManager.createEvent_EditTriggerID)
                  .lOutcomes
                  .size()
               - 1;
            ...
            break;
         case 43:
            CFG.eventsManager.createScenarioEvents.lDecisions.get(CFG.eventsManager.createEvent_EditTriggerID).lOutcomes.add(new Event_Outcome_ProvokeRebels());
            CFG.eventsManager.createEvent_EditConditionID = CFG.eventsManager.createScenarioEvents.lDecisions.get(CFG.eventsManager.createEvent_EditTriggerID)
                  .lOutcomes
                  .size()
               - 1;
         ...
         case 44:
            CFG.eventsManager.createScenarioEvents.lDecisions.get(CFG.eventsManager.createEvent_EditTriggerID)
               .lOutcomes
               .add(new Event_Outcome_ImposeSanctions());
            CFG.eventsManager.createEvent_EditConditionID = CFG.eventsManager.createScenarioEvents.lDecisions.get(CFG.eventsManager.createEvent_EditTriggerID)
                  .lOutcomes
                  .size()
               - 1;
            ...
            break;
         case 45:
            CFG.eventsManager.createScenarioEvents.lDecisions.get(CFG.eventsManager.createEvent_EditTriggerID).lOutcomes.add(new Event_Outcome_AdmPolicy());
            CFG.eventsManager.createEvent_EditConditionID = CFG.eventsManager.createScenarioEvents.lDecisions.get(CFG.eventsManager.createEvent_EditTriggerID)
                  .lOutcomes
                  .size()
               - 1;
            ...
            break;
         case 46:
            CFG.eventsManager.createScenarioEvents.lDecisions.get(CFG.eventsManager.createEvent_EditTriggerID).lOutcomes.add(new Event_Outcome_FestivalAll());
            CFG.eventsManager.createEvent_EditConditionID = CFG.eventsManager.createScenarioEvents.lDecisions.get(CFG.eventsManager.createEvent_EditTriggerID)
                  .lOutcomes
                  .size()
               - 1;
            ...
            break;
         case 47:
            CFG.eventsManager.createScenarioEvents.lDecisions.get(CFG.eventsManager.createEvent_EditTriggerID).lOutcomes.add(new Event_Outcome_AssimilateAll());
            CFG.eventsManager.createEvent_EditConditionID = CFG.eventsManager.createScenarioEvents.lDecisions.get(CFG.eventsManager.createEvent_EditTriggerID)
                  .lOutcomes
                  .size()
               - 1;
         ...
         case 48:
            CFG.eventsManager.createScenarioEvents.lDecisions.get(CFG.eventsManager.createEvent_EditTriggerID)
               .lOutcomes
               .add(new Event_Outcome_MilitaryExpertise());
            CFG.eventsManager.createEvent_EditConditionID = CFG.eventsManager.createScenarioEvents.lDecisions.get(CFG.eventsManager.createEvent_EditTriggerID)
                  .lOutcomes
                  .size()
               - 1;
         ...
         case 49:
            CFG.eventsManager.createScenarioEvents.lDecisions.get(CFG.eventsManager.createEvent_EditTriggerID)
               .lOutcomes
               .add(new Event_Outcome_MilitaryAttack());
            CFG.eventsManager.createEvent_EditConditionID = CFG.eventsManager.createScenarioEvents.lDecisions.get(CFG.eventsManager.createEvent_EditTriggerID)
                  .lOutcomes
                  .size()
               - 1;
         ...
         case 50:
            CFG.eventsManager.createScenarioEvents.lDecisions.get(CFG.eventsManager.createEvent_EditTriggerID)
               .lOutcomes
               .add(new Event_Outcome_MilitaryDefense());
            CFG.eventsManager.createEvent_EditConditionID = CFG.eventsManager.createScenarioEvents.lDecisions.get(CFG.eventsManager.createEvent_EditTriggerID)
                  .lOutcomes
                  .size()
               - 1;
         ...
         case 51:
            CFG.eventsManager.createScenarioEvents.lDecisions.get(CFG.eventsManager.createEvent_EditTriggerID)
               .lOutcomes
               .add(new Event_Outcome_GoldenAgeProsp());
            CFG.eventsManager.createEvent_EditConditionID = CFG.eventsManager.createScenarioEvents.lDecisions.get(CFG.eventsManager.createEvent_EditTriggerID)
                  .lOutcomes
                  .size()
               - 1;
         ...
         case 52:
            CFG.eventsManager.createScenarioEvents.lDecisions.get(CFG.eventsManager.createEvent_EditTriggerID)
               .lOutcomes
               .add(new Event_Outcome_GoldenAgeMilitary());
            CFG.eventsManager.createEvent_EditConditionID = CFG.eventsManager.createScenarioEvents.lDecisions.get(CFG.eventsManager.createEvent_EditTriggerID)
                  .lOutcomes
                  .size()
               - 1;
         ...
         case 53:
            CFG.eventsManager.createScenarioEvents.lDecisions.get(CFG.eventsManager.createEvent_EditTriggerID)
               .lOutcomes
               .add(new Event_Outcome_GoldenAgeScience());
            CFG.eventsManager.createEvent_EditConditionID = CFG.eventsManager.createScenarioEvents.lDecisions.get(CFG.eventsManager.createEvent_EditTriggerID)
                  .lOutcomes
                  .size()
               - 1;
            ...
            break;
         case 54:
            CFG.eventsManager.createScenarioEvents.lDecisions.get(CFG.eventsManager.createEvent_EditTriggerID).lOutcomes.add(new Event_Outcome_RandFarms());
            CFG.eventsManager.createEvent_EditConditionID = CFG.eventsManager.createScenarioEvents.lDecisions.get(CFG.eventsManager.createEvent_EditTriggerID)
                  .lOutcomes
                  .size()
               - 1;
            ...
            break;
         case 55:
            CFG.eventsManager.createScenarioEvents.lDecisions.get(CFG.eventsManager.createEvent_EditTriggerID).lOutcomes.add(new Event_Outcome_RandFort());
            CFG.eventsManager.createEvent_EditConditionID = CFG.eventsManager.createScenarioEvents.lDecisions.get(CFG.eventsManager.createEvent_EditTriggerID)
                  .lOutcomes
                  .size()
               - 1;
            ...
            break;
         case 56:
            CFG.eventsManager.createScenarioEvents.lDecisions.get(CFG.eventsManager.createEvent_EditTriggerID).lOutcomes.add(new Event_Outcome_RandTowers());
            CFG.eventsManager.createEvent_EditConditionID = CFG.eventsManager.createScenarioEvents.lDecisions.get(CFG.eventsManager.createEvent_EditTriggerID)
                  .lOutcomes
                  .size()
               - 1;
            ...
            break;
         case 57:
            CFG.eventsManager.createScenarioEvents.lDecisions.get(CFG.eventsManager.createEvent_EditTriggerID).lOutcomes.add(new Event_Outcome_RandWorkshop());
            CFG.eventsManager.createEvent_EditConditionID = CFG.eventsManager.createScenarioEvents.lDecisions.get(CFG.eventsManager.createEvent_EditTriggerID)
                  .lOutcomes
                  .size()
               - 1;
            ...
            break;
         case 58:
            CFG.eventsManager.createScenarioEvents.lDecisions.get(CFG.eventsManager.createEvent_EditTriggerID).lOutcomes.add(new Event_Outcome_RandMarkets());
            CFG.eventsManager.createEvent_EditConditionID = CFG.eventsManager.createScenarioEvents.lDecisions.get(CFG.eventsManager.createEvent_EditTriggerID)
                  .lOutcomes
                  .size()
               - 1;
            ...
            break;
         case 59:
            CFG.eventsManager.createScenarioEvents.lDecisions.get(CFG.eventsManager.createEvent_EditTriggerID).lOutcomes.add(new Event_Outcome_RandLibrary());
            CFG.eventsManager.createEvent_EditConditionID = CFG.eventsManager.createScenarioEvents.lDecisions.get(CFG.eventsManager.createEvent_EditTriggerID)
                  .lOutcomes
                  .size()
               - 1;
            ...
            break;
         case 60:
            CFG.eventsManager.createScenarioEvents.lDecisions.get(CFG.eventsManager.createEvent_EditTriggerID).lOutcomes.add(new Event_Outcome_RandArmoury());
            CFG.eventsManager.createEvent_EditConditionID = CFG.eventsManager.createScenarioEvents.lDecisions.get(CFG.eventsManager.createEvent_EditTriggerID)
                  .lOutcomes
                  .size()
               - 1;
            ...
            break;
         case 61:
            CFG.eventsManager.createScenarioEvents.lDecisions.get(CFG.eventsManager.createEvent_EditTriggerID).lOutcomes.add(new Event_Outcome_RandSupply());
            CFG.eventsManager.createEvent_EditConditionID = CFG.eventsManager.createScenarioEvents.lDecisions.get(CFG.eventsManager.createEvent_EditTriggerID)
                  .lOutcomes
                  .size()
               - 1;
            ...
            break;
         case 62:
            CFG.eventsManager.createScenarioEvents.lDecisions.get(CFG.eventsManager.createEvent_EditTriggerID).lOutcomes.add(new Event_Outcome_RandFestivals());
            CFG.eventsManager.createEvent_EditConditionID = CFG.eventsManager.createScenarioEvents.lDecisions.get(CFG.eventsManager.createEvent_EditTriggerID)
                  .lOutcomes
                  .size()
               - 1;
            ...
            break;
         case 63:
            CFG.eventsManager.createScenarioEvents.lDecisions.get(CFG.eventsManager.createEvent_EditTriggerID).lOutcomes.add(new Event_Outcome_RenameCiv());
            CFG.eventsManager.createEvent_EditConditionID = CFG.eventsManager.createScenarioEvents.lDecisions.get(CFG.eventsManager.createEvent_EditTriggerID)
                  .lOutcomes
                  .size()
               - 1;
            ...
            break;
         case 64:
            CFG.eventsManager.createScenarioEvents.lDecisions.get(CFG.eventsManager.createEvent_EditTriggerID).lOutcomes.add(new Event_Outcome_RenameProv());
            CFG.eventsManager.createEvent_EditConditionID = CFG.eventsManager.createScenarioEvents.lDecisions.get(CFG.eventsManager.createEvent_EditTriggerID)
                  .lOutcomes
                  .size()
               - 1;
            ...
            break;
         case 65:
            CFG.eventsManager.createScenarioEvents.lDecisions.get(CFG.eventsManager.createEvent_EditTriggerID).lOutcomes.add(new Event_Outcome_RemoveArmyX());
            CFG.eventsManager.createEvent_EditConditionID = CFG.eventsManager.createScenarioEvents.lDecisions.get(CFG.eventsManager.createEvent_EditTriggerID)
                  .lOutcomes
                  .size()
               - 1;
         ...
         case 66:
            CFG.eventsManager.createScenarioEvents.lDecisions.get(CFG.eventsManager.createEvent_EditTriggerID)
               .lOutcomes
               .add(new Event_Outcome_GlobalEconomyPerc());
            CFG.eventsManager.createEvent_EditConditionID = CFG.eventsManager.createScenarioEvents.lDecisions.get(CFG.eventsManager.createEvent_EditTriggerID)
                  .lOutcomes
                  .size()
               - 1;
         ...
         case 67:
            CFG.eventsManager.createScenarioEvents.lDecisions.get(CFG.eventsManager.createEvent_EditTriggerID)
               .lOutcomes
               .add(new Event_Outcome_GlobalPopulationPerc());
            CFG.eventsManager.createEvent_EditConditionID = CFG.eventsManager.createScenarioEvents.lDecisions.get(CFG.eventsManager.createEvent_EditTriggerID)
                  .lOutcomes
                  .size()
               - 1;
         ...
         case 68:
            CFG.eventsManager.createScenarioEvents.lDecisions.get(CFG.eventsManager.createEvent_EditTriggerID)
               .lOutcomes
               .add(new Event_Outcome_GlobalDevelopmentPerc());
            CFG.eventsManager.createEvent_EditConditionID = CFG.eventsManager.createScenarioEvents.lDecisions.get(CFG.eventsManager.createEvent_EditTriggerID)
                  .lOutcomes
                  .size()
               - 1;
         ...
         case 69:
            CFG.eventsManager.createScenarioEvents.lDecisions.get(CFG.eventsManager.createEvent_EditTriggerID)
               .lOutcomes
               .add(new Event_Outcome_GlobalHappinessPerc());
            CFG.eventsManager.createEvent_EditConditionID = CFG.eventsManager.createScenarioEvents.lDecisions.get(CFG.eventsManager.createEvent_EditTriggerID)
                  .lOutcomes
                  .size()
               - 1;
         ...
         case 70:
            CFG.eventsManager.createScenarioEvents.lDecisions.get(CFG.eventsManager.createEvent_EditTriggerID)
               .lOutcomes
               .add(new Event_Outcome_GlobalArmyPerc());
            CFG.eventsManager.createEvent_EditConditionID = CFG.eventsManager.createScenarioEvents.lDecisions.get(CFG.eventsManager.createEvent_EditTriggerID)
                  .lOutcomes
                  .size()
               - 1;
            ...
            break;
         case 71:
            CFG.eventsManager.createScenarioEvents.lDecisions.get(CFG.eventsManager.createEvent_EditTriggerID).lOutcomes.add(new Event_Outcome_PlayerCiv());
            CFG.eventsManager.createEvent_EditConditionID = CFG.eventsManager.createScenarioEvents.lDecisions.get(CFG.eventsManager.createEvent_EditTriggerID)
                  .lOutcomes
                  .size()
               - 1;
            ...
            break;
         case 72:
            CFG.eventsManager.createScenarioEvents.lDecisions.get(CFG.eventsManager.createEvent_EditTriggerID).lOutcomes.add(new Event_Outcome_Exp());
            CFG.eventsManager.createEvent_EditConditionID = CFG.eventsManager.createScenarioEvents.lDecisions.get(CFG.eventsManager.createEvent_EditTriggerID)
                  .lOutcomes
                  .size()
               - 1;

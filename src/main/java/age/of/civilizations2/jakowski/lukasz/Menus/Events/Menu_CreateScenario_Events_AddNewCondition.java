...
public class Menu_CreateScenario_Events_AddNewCondition extends Menu {
   ...
   public void updateLang() {
      ...
      this.getMenuElem(97).setTextE("Counter ==");
   ...
   public final void actionEL(int iID) {
      switch (iID) {
         case 0:
            ...
            break;
         case 1:
            CFG.eventsManager.createScenarioEvents.getTrigger(CFG.eventsManager.createEvent_EditTriggerID).lConditions.add(new Event_Conditions_EventChance());
         ...
         case 2:
            ...
            break;
         case 3:
            CFG.eventsManager.createScenarioEvents.getTrigger(CFG.eventsManager.createEvent_EditTriggerID).lConditions.add(new Event_Conditions_CivExist());
            CFG.eventsManager.createEvent_EditConditionID = CFG.eventsManager
                  .createScenarioEvents
                  .getTrigger(CFG.eventsManager.createEvent_EditTriggerID)
                  .lConditions
         ...
         case 5:
            ...
            break;
         case 6:
            CFG.eventsManager.createScenarioEvents.getTrigger(CFG.eventsManager.createEvent_EditTriggerID).lConditions.add(new Event_Conditions_HaveArmy());
            CFG.eventsManager.createEvent_EditConditionID = CFG.eventsManager
                  .createScenarioEvents
                  .getTrigger(CFG.eventsManager.createEvent_EditTriggerID)
                  .lConditions
            ...
            break;
         case 7:
            CFG.eventsManager.createScenarioEvents.getTrigger(CFG.eventsManager.createEvent_EditTriggerID).lConditions.add(new Event_Conditions_HaveCore());
            CFG.eventsManager.createEvent_EditConditionID = CFG.eventsManager
                  .createScenarioEvents
                  .getTrigger(CFG.eventsManager.createEvent_EditTriggerID)
                  .lConditions
            ...
            break;
         case 8:
            CFG.eventsManager.createScenarioEvents.getTrigger(CFG.eventsManager.createEvent_EditTriggerID).lConditions.add(new Event_Conditions_IsCapital());
            CFG.eventsManager.createEvent_EditConditionID = CFG.eventsManager
                  .createScenarioEvents
                  .getTrigger(CFG.eventsManager.createEvent_EditTriggerID)
                  .lConditions
         ...
         case 10:
            ...
            break;
         case 11:
            CFG.eventsManager.createScenarioEvents.getTrigger(CFG.eventsManager.createEvent_EditTriggerID).lConditions.add(new Event_Conditions_NumOfUnits());
            CFG.eventsManager.createEvent_EditConditionID = CFG.eventsManager
                  .createScenarioEvents
                  .getTrigger(CFG.eventsManager.createEvent_EditTriggerID)
                  .lConditions
         ...
         case 12:
            ...
            break;
         case 13:
            CFG.eventsManager.createScenarioEvents.getTrigger(CFG.eventsManager.createEvent_EditTriggerID).lConditions.add(new Event_Conditions_NumOfVassals());
            CFG.eventsManager.createEvent_EditConditionID = CFG.eventsManager
                  .createScenarioEvents
                  .getTrigger(CFG.eventsManager.createEvent_EditTriggerID)
                  .lConditions
         ...
         case 14:
            ...
            break;
         case 15:
            CFG.eventsManager.createScenarioEvents.getTrigger(CFG.eventsManager.createEvent_EditTriggerID).lConditions.add(new Event_Conditions_NumOfAllies());
            CFG.eventsManager.createEvent_EditConditionID = CFG.eventsManager
                  .createScenarioEvents
                  .getTrigger(CFG.eventsManager.createEvent_EditTriggerID)
                  .lConditions
         ...
         case 16:
            ...
            break;
         case 17:
            CFG.eventsManager.createScenarioEvents.getTrigger(CFG.eventsManager.createEvent_EditTriggerID).lConditions.add(new Event_Conditions_NumOfWars());
            CFG.eventsManager.createEvent_EditConditionID = CFG.eventsManager
                  .createScenarioEvents
                  .getTrigger(CFG.eventsManager.createEvent_EditTriggerID)
                  .lConditions
         ...
         case 20:
            ...
            break;
         case 21:
            CFG.eventsManager.createScenarioEvents.getTrigger(CFG.eventsManager.createEvent_EditTriggerID).lConditions.add(new Event_Conditions_Population());
            CFG.eventsManager.createEvent_EditConditionID = CFG.eventsManager
                  .createScenarioEvents
                  .getTrigger(CFG.eventsManager.createEvent_EditTriggerID)
                  .lConditions
         ...
         case 22:
            ...
            break;
         case 23:
            CFG.eventsManager.createScenarioEvents.getTrigger(CFG.eventsManager.createEvent_EditTriggerID).lConditions.add(new Event_Conditions_Economy());
            CFG.eventsManager.createEvent_EditConditionID = CFG.eventsManager
                  .createScenarioEvents
                  .getTrigger(CFG.eventsManager.createEvent_EditTriggerID)
                  .lConditions
            ...
            break;
         case 24:
            CFG.eventsManager.createScenarioEvents.getTrigger(CFG.eventsManager.createEvent_EditTriggerID).lConditions.add(new Event_Conditions_Economy_Low());
            CFG.eventsManager.createEvent_EditConditionID = CFG.eventsManager
                  .createScenarioEvents
                  .getTrigger(CFG.eventsManager.createEvent_EditTriggerID)
                  .lConditions
            ...
            break;
         case 25:
            CFG.eventsManager.createScenarioEvents.getTrigger(CFG.eventsManager.createEvent_EditTriggerID).lConditions.add(new Event_Conditions_Relation());
            CFG.eventsManager.createEvent_EditConditionID = CFG.eventsManager
                  .createScenarioEvents
                  .getTrigger(CFG.eventsManager.createEvent_EditTriggerID)
                  .lConditions
            ...
            break;
         case 26:
            CFG.eventsManager.createScenarioEvents.getTrigger(CFG.eventsManager.createEvent_EditTriggerID).lConditions.add(new Event_Conditions_Relation_Low());
            CFG.eventsManager.createEvent_EditConditionID = CFG.eventsManager
                  .createScenarioEvents
                  .getTrigger(CFG.eventsManager.createEvent_EditTriggerID)
                  .lConditions
            ...
            break;
         case 27:
            CFG.eventsManager.createScenarioEvents.getTrigger(CFG.eventsManager.createEvent_EditTriggerID).lConditions.add(new Event_Conditions_IsAtWar());
            CFG.eventsManager.createEvent_EditConditionID = CFG.eventsManager
                  .createScenarioEvents
                  .getTrigger(CFG.eventsManager.createEvent_EditTriggerID)
                  .lConditions
            ...
            break;
         case 28:
            CFG.eventsManager.createScenarioEvents.getTrigger(CFG.eventsManager.createEvent_EditTriggerID).lConditions.add(new Event_Conditions_AtWar());
            CFG.eventsManager.createEvent_EditConditionID = CFG.eventsManager
                  .createScenarioEvents
                  .getTrigger(CFG.eventsManager.createEvent_EditTriggerID)
                  .lConditions
            ...
            break;
         case 29:
            CFG.eventsManager.createScenarioEvents.getTrigger(CFG.eventsManager.createEvent_EditTriggerID).lConditions.add(new Event_Conditions_Allies());
            CFG.eventsManager.createEvent_EditConditionID = CFG.eventsManager
                  .createScenarioEvents
                  .getTrigger(CFG.eventsManager.createEvent_EditTriggerID)
                  .lConditions
         ...
         case 31:
            ...
            break;
         case 32:
            CFG.eventsManager.createScenarioEvents.getTrigger(CFG.eventsManager.createEvent_EditTriggerID).lConditions.add(new Event_Conditions_Independence());
            CFG.eventsManager.createEvent_EditConditionID = CFG.eventsManager
                  .createScenarioEvents
                  .getTrigger(CFG.eventsManager.createEvent_EditTriggerID)
                  .lConditions
         ...
         case 33:
            ...
            break;
         case 34:
            CFG.eventsManager.createScenarioEvents.getTrigger(CFG.eventsManager.createEvent_EditTriggerID).lConditions.add(new Event_Conditions_IsAVassal());
            CFG.eventsManager.createEvent_EditConditionID = CFG.eventsManager
                  .createScenarioEvents
                  .getTrigger(CFG.eventsManager.createEvent_EditTriggerID)
                  .lConditions
         ...
         case 35:
            ...
            break;
         case 36:
            CFG.eventsManager.createScenarioEvents.getTrigger(CFG.eventsManager.createEvent_EditTriggerID).lConditions.add(new Event_Conditions_IsPartOfHRE());
            CFG.eventsManager.createEvent_EditConditionID = CFG.eventsManager
                  .createScenarioEvents
                  .getTrigger(CFG.eventsManager.createEvent_EditTriggerID)
                  .lConditions
            ...
            break;
         case 37:
            CFG.eventsManager.createScenarioEvents.getTrigger(CFG.eventsManager.createEvent_EditTriggerID).lConditions.add(new Event_Conditions_Ideology());
            CFG.eventsManager.createEvent_EditConditionID = CFG.eventsManager
                  .createScenarioEvents
                  .getTrigger(CFG.eventsManager.createEvent_EditTriggerID)
                  .lConditions
            ...
            break;
         case 38:
            CFG.eventsManager.createScenarioEvents.getTrigger(CFG.eventsManager.createEvent_EditTriggerID).lConditions.add(new Event_Conditions_Technology());
            CFG.eventsManager.createEvent_EditConditionID = CFG.eventsManager
                  .createScenarioEvents
                  .getTrigger(CFG.eventsManager.createEvent_EditTriggerID)
                  .lConditions
         ...
         case 39:
            ...
            break;
         case 40:
            CFG.eventsManager.createScenarioEvents.getTrigger(CFG.eventsManager.createEvent_EditTriggerID).lConditions.add(new Event_Conditions_Development());
            CFG.eventsManager.createEvent_EditConditionID = CFG.eventsManager
                  .createScenarioEvents
                  .getTrigger(CFG.eventsManager.createEvent_EditTriggerID)
                  .lConditions
         ...
         case 41:
            ...
            break;
         case 42:
            CFG.eventsManager.createScenarioEvents.getTrigger(CFG.eventsManager.createEvent_EditTriggerID).lConditions.add(new Event_Conditions_Happiness());
            CFG.eventsManager.createEvent_EditConditionID = CFG.eventsManager
                  .createScenarioEvents
                  .getTrigger(CFG.eventsManager.createEvent_EditTriggerID)
                  .lConditions
         ...
         case 43:
            ...
            break;
         case 44:
            CFG.eventsManager.createScenarioEvents.getTrigger(CFG.eventsManager.createEvent_EditTriggerID).lConditions.add(new Event_Conditions_Treasury());
            CFG.eventsManager.createEvent_EditConditionID = CFG.eventsManager
                  .createScenarioEvents
                  .getTrigger(CFG.eventsManager.createEvent_EditTriggerID)
                  .lConditions
            ...
            break;
         case 45:
            CFG.eventsManager.createScenarioEvents.getTrigger(CFG.eventsManager.createEvent_EditTriggerID).lConditions.add(new Event_Conditions_Treasury_Low());
            CFG.eventsManager.createEvent_EditConditionID = CFG.eventsManager
                  .createScenarioEvents
                  .getTrigger(CFG.eventsManager.createEvent_EditTriggerID)
                  .lConditions
         ...
         case 46:
            ...
            break;
         case 47:
            CFG.eventsManager.createScenarioEvents.getTrigger(CFG.eventsManager.createEvent_EditTriggerID).lConditions.add(new Event_Conditions_Wasteland());
            CFG.eventsManager.createEvent_EditConditionID = CFG.eventsManager
                  .createScenarioEvents
                  .getTrigger(CFG.eventsManager.createEvent_EditTriggerID)
                  .lConditions
            ...
            break;
         case 48:
            CFG.eventsManager.createScenarioEvents.getTrigger(CFG.eventsManager.createEvent_EditTriggerID).lConditions.add(new Event_Conditions_Neutral());
            CFG.eventsManager.createEvent_EditConditionID = CFG.eventsManager
                  .createScenarioEvents
                  .getTrigger(CFG.eventsManager.createEvent_EditTriggerID)
                  .lConditions
            ...
            break;
         case 49:
            CFG.eventsManager.createScenarioEvents.getTrigger(CFG.eventsManager.createEvent_EditTriggerID).lConditions.add(new Event_Conditions_Fort());
            CFG.eventsManager.createEvent_EditConditionID = CFG.eventsManager
                  .createScenarioEvents
                  .getTrigger(CFG.eventsManager.createEvent_EditTriggerID)
                  .lConditions
            ...
            break;
         case 50:
            CFG.eventsManager.createScenarioEvents.getTrigger(CFG.eventsManager.createEvent_EditTriggerID).lConditions.add(new Event_Conditions_Port());
            CFG.eventsManager.createEvent_EditConditionID = CFG.eventsManager
                  .createScenarioEvents
                  .getTrigger(CFG.eventsManager.createEvent_EditTriggerID)
                  .lConditions
            ...
            break;
         case 51:
            CFG.eventsManager.createScenarioEvents.getTrigger(CFG.eventsManager.createEvent_EditTriggerID).lConditions.add(new Event_Conditions_WatchTower());
            CFG.eventsManager.createEvent_EditConditionID = CFG.eventsManager
                  .createScenarioEvents
                  .getTrigger(CFG.eventsManager.createEvent_EditTriggerID)
                  .lConditions
            ...
            break;
         case 52:
            CFG.eventsManager.createScenarioEvents.getTrigger(CFG.eventsManager.createEvent_EditTriggerID).lConditions.add(new Event_Conditions_Farm());
            CFG.eventsManager.createEvent_EditConditionID = CFG.eventsManager
                  .createScenarioEvents
                  .getTrigger(CFG.eventsManager.createEvent_EditTriggerID)
                  .lConditions
            ...
            break;
         case 53:
            CFG.eventsManager.createScenarioEvents.getTrigger(CFG.eventsManager.createEvent_EditTriggerID).lConditions.add(new Event_Conditions_Religion());
            CFG.eventsManager.createEvent_EditConditionID = CFG.eventsManager
                  .createScenarioEvents
                  .getTrigger(CFG.eventsManager.createEvent_EditTriggerID)
                  .lConditions
            ...
            break;
         case 54:
            CFG.eventsManager.createScenarioEvents.getTrigger(CFG.eventsManager.createEvent_EditTriggerID).lConditions.add(new Event_Conditions_Leader());
            CFG.eventsManager.createEvent_EditConditionID = CFG.eventsManager
                  .createScenarioEvents
                  .getTrigger(CFG.eventsManager.createEvent_EditTriggerID)
                  .lConditions
            ...
            break;
         case 55:
            CFG.eventsManager.createScenarioEvents.getTrigger(CFG.eventsManager.createEvent_EditTriggerID).lConditions.add(new Event_Conditions_AdmPolicy());
            CFG.eventsManager.createEvent_EditConditionID = CFG.eventsManager
                  .createScenarioEvents
                  .getTrigger(CFG.eventsManager.createEvent_EditTriggerID)
                  .lConditions
            ...
            break;
         case 56:
            CFG.eventsManager.createScenarioEvents.getTrigger(CFG.eventsManager.createEvent_EditTriggerID).lConditions.add(new Event_Conditions_Nukes());
            CFG.eventsManager.createEvent_EditConditionID = CFG.eventsManager
                  .createScenarioEvents
                  .getTrigger(CFG.eventsManager.createEvent_EditTriggerID)
                  .lConditions
            ...
            break;
         case 57:
            CFG.eventsManager.createScenarioEvents.getTrigger(CFG.eventsManager.createEvent_EditTriggerID).lConditions.add(new Event_Conditions_NukesLow());
            CFG.eventsManager.createEvent_EditConditionID = CFG.eventsManager
                  .createScenarioEvents
                  .getTrigger(CFG.eventsManager.createEvent_EditTriggerID)
                  .lConditions
            ...
            break;
         case 58:
            CFG.eventsManager.createScenarioEvents.getTrigger(CFG.eventsManager.createEvent_EditTriggerID).lConditions.add(new Event_Conditions_Investments());
            CFG.eventsManager.createEvent_EditConditionID = CFG.eventsManager
                  .createScenarioEvents
                  .getTrigger(CFG.eventsManager.createEvent_EditTriggerID)
                  .lConditions
         ...
         case 59:
            CFG.eventsManager
               ...
               .getTrigger(CFG.eventsManager.createEvent_EditTriggerID)
               .lConditions
               .add(new Event_Conditions_InvestmentsLow());
            CFG.eventsManager.createEvent_EditConditionID = CFG.eventsManager
                  .createScenarioEvents
                  .getTrigger(CFG.eventsManager.createEvent_EditTriggerID)
                  .lConditions
         ...
         case 60:
            CFG.eventsManager
               ...
               .getTrigger(CFG.eventsManager.createEvent_EditTriggerID)
               .lConditions
               .add(new Event_Conditions_Assimilations());
            CFG.eventsManager.createEvent_EditConditionID = CFG.eventsManager
                  .createScenarioEvents
                  .getTrigger(CFG.eventsManager.createEvent_EditTriggerID)
                  .lConditions
         ...
         case 61:
            CFG.eventsManager
               ...
               .getTrigger(CFG.eventsManager.createEvent_EditTriggerID)
               .lConditions
               .add(new Event_Conditions_AssimilationsLow());
            CFG.eventsManager.createEvent_EditConditionID = CFG.eventsManager
                  .createScenarioEvents
                  .getTrigger(CFG.eventsManager.createEvent_EditTriggerID)
                  .lConditions
            ...
            break;
         case 62:
            CFG.eventsManager.createScenarioEvents.getTrigger(CFG.eventsManager.createEvent_EditTriggerID).lConditions.add(new Event_Conditions_Festivals());
            CFG.eventsManager.createEvent_EditConditionID = CFG.eventsManager
                  .createScenarioEvents
                  .getTrigger(CFG.eventsManager.createEvent_EditTriggerID)
                  .lConditions
            ...
            break;
         case 63:
            CFG.eventsManager.createScenarioEvents.getTrigger(CFG.eventsManager.createEvent_EditTriggerID).lConditions.add(new Event_Conditions_FestivalsLow());
            CFG.eventsManager.createEvent_EditConditionID = CFG.eventsManager
                  .createScenarioEvents
                  .getTrigger(CFG.eventsManager.createEvent_EditTriggerID)
                  .lConditions
         ...
         case 64:
            CFG.eventsManager
               ...
               .getTrigger(CFG.eventsManager.createEvent_EditTriggerID)
               .lConditions
               .add(new Event_Conditions_FestivalsCost());
            CFG.eventsManager.createEvent_EditConditionID = CFG.eventsManager
                  .createScenarioEvents
                  .getTrigger(CFG.eventsManager.createEvent_EditTriggerID)
                  .lConditions
         ...
         case 65:
            CFG.eventsManager
               ...
               .getTrigger(CFG.eventsManager.createEvent_EditTriggerID)
               .lConditions
               .add(new Event_Conditions_FestivalsCostLow());
            CFG.eventsManager.createEvent_EditConditionID = CFG.eventsManager
                  .createScenarioEvents
                  .getTrigger(CFG.eventsManager.createEvent_EditTriggerID)
                  .lConditions
         ...
         case 66:
            CFG.eventsManager
               ...
               .getTrigger(CFG.eventsManager.createEvent_EditTriggerID)
               .lConditions
               .add(new Event_Conditions_InvestsEcoCost());
            CFG.eventsManager.createEvent_EditConditionID = CFG.eventsManager
                  .createScenarioEvents
                  .getTrigger(CFG.eventsManager.createEvent_EditTriggerID)
                  .lConditions
         ...
         case 67:
            CFG.eventsManager
               ...
               .getTrigger(CFG.eventsManager.createEvent_EditTriggerID)
               .lConditions
               .add(new Event_Conditions_InvestsEcoCostLow());
            CFG.eventsManager.createEvent_EditConditionID = CFG.eventsManager
                  .createScenarioEvents
                  .getTrigger(CFG.eventsManager.createEvent_EditTriggerID)
                  .lConditions
         ...
         case 68:
            CFG.eventsManager
               ...
               .getTrigger(CFG.eventsManager.createEvent_EditTriggerID)
               .lConditions
               .add(new Event_Conditions_InvestsDevCost());
            CFG.eventsManager.createEvent_EditConditionID = CFG.eventsManager
                  .createScenarioEvents
                  .getTrigger(CFG.eventsManager.createEvent_EditTriggerID)
                  .lConditions
         ...
         case 69:
            CFG.eventsManager
               ...
               .getTrigger(CFG.eventsManager.createEvent_EditTriggerID)
               .lConditions
               .add(new Event_Conditions_InvestsDevCostLow());
            CFG.eventsManager.createEvent_EditConditionID = CFG.eventsManager
                  .createScenarioEvents
                  .getTrigger(CFG.eventsManager.createEvent_EditTriggerID)
                  .lConditions
         ...
         case 70:
            CFG.eventsManager
               ...
               .getTrigger(CFG.eventsManager.createEvent_EditTriggerID)
               .lConditions
               .add(new Event_Conditions_InvestsEcoGained());
            CFG.eventsManager.createEvent_EditConditionID = CFG.eventsManager
                  .createScenarioEvents
                  .getTrigger(CFG.eventsManager.createEvent_EditTriggerID)
                  .lConditions
         ...
         case 71:
            CFG.eventsManager
               ...
               .getTrigger(CFG.eventsManager.createEvent_EditTriggerID)
               .lConditions
               .add(new Event_Conditions_InvestsEcoGainedLow());
            CFG.eventsManager.createEvent_EditConditionID = CFG.eventsManager
                  .createScenarioEvents
                  .getTrigger(CFG.eventsManager.createEvent_EditTriggerID)
                  .lConditions
         ...
         case 72:
            CFG.eventsManager
               ...
               .getTrigger(CFG.eventsManager.createEvent_EditTriggerID)
               .lConditions
               .add(new Event_Conditions_AssimilationsCost());
            CFG.eventsManager.createEvent_EditConditionID = CFG.eventsManager
                  .createScenarioEvents
                  .getTrigger(CFG.eventsManager.createEvent_EditTriggerID)
                  .lConditions
         ...
         case 73:
            CFG.eventsManager
               ...
               .getTrigger(CFG.eventsManager.createEvent_EditTriggerID)
               .lConditions
               .add(new Event_Conditions_AssimilationsCostLow());
            CFG.eventsManager.createEvent_EditConditionID = CFG.eventsManager
                  .createScenarioEvents
                  .getTrigger(CFG.eventsManager.createEvent_EditTriggerID)
                  .lConditions
         ...
         case 74:
            CFG.eventsManager
               ...
               .getTrigger(CFG.eventsManager.createEvent_EditTriggerID)
               .lConditions
               .add(new Event_Conditions_MilitaryExpertise());
            CFG.eventsManager.createEvent_EditConditionID = CFG.eventsManager
                  .createScenarioEvents
                  .getTrigger(CFG.eventsManager.createEvent_EditTriggerID)
                  .lConditions
         ...
         case 75:
            CFG.eventsManager
               ...
               .getTrigger(CFG.eventsManager.createEvent_EditTriggerID)
               .lConditions
               .add(new Event_Conditions_MilitaryExpertiseLow());
            CFG.eventsManager.createEvent_EditConditionID = CFG.eventsManager
                  .createScenarioEvents
                  .getTrigger(CFG.eventsManager.createEvent_EditTriggerID)
                  .lConditions
            ...
            break;
         case 76:
            CFG.eventsManager.createScenarioEvents.getTrigger(CFG.eventsManager.createEvent_EditTriggerID).lConditions.add(new Event_Conditions_WarCasu());
            CFG.eventsManager.createEvent_EditConditionID = CFG.eventsManager
                  .createScenarioEvents
                  .getTrigger(CFG.eventsManager.createEvent_EditTriggerID)
                  .lConditions
            ...
            break;
         case 77:
            CFG.eventsManager.createScenarioEvents.getTrigger(CFG.eventsManager.createEvent_EditTriggerID).lConditions.add(new Event_Conditions_WarCasuLow());
            CFG.eventsManager.createEvent_EditConditionID = CFG.eventsManager
                  .createScenarioEvents
                  .getTrigger(CFG.eventsManager.createEvent_EditTriggerID)
                  .lConditions
         ...
         case 78:
            CFG.eventsManager
               ...
               .getTrigger(CFG.eventsManager.createEvent_EditTriggerID)
               .lConditions
               .add(new Event_Conditions_ConquredProvs());
            CFG.eventsManager.createEvent_EditConditionID = CFG.eventsManager
                  .createScenarioEvents
                  .getTrigger(CFG.eventsManager.createEvent_EditTriggerID)
                  .lConditions
         ...
         case 79:
            CFG.eventsManager
               ...
               .getTrigger(CFG.eventsManager.createEvent_EditTriggerID)
               .lConditions
               .add(new Event_Conditions_ConquredProvsLow());
            CFG.eventsManager.createEvent_EditConditionID = CFG.eventsManager
                  .createScenarioEvents
                  .getTrigger(CFG.eventsManager.createEvent_EditTriggerID)
                  .lConditions
         ...
         case 80:
            CFG.eventsManager
               ...
               .getTrigger(CFG.eventsManager.createEvent_EditTriggerID)
               .lConditions
               .add(new Event_Conditions_BuildingsConstructed());
            CFG.eventsManager.createEvent_EditConditionID = CFG.eventsManager
                  .createScenarioEvents
                  .getTrigger(CFG.eventsManager.createEvent_EditTriggerID)
                  .lConditions
         ...
         case 81:
            CFG.eventsManager
               ...
               .getTrigger(CFG.eventsManager.createEvent_EditTriggerID)
               .lConditions
               .add(new Event_Conditions_BuildingsConstructedLow());
            CFG.eventsManager.createEvent_EditConditionID = CFG.eventsManager
                  .createScenarioEvents
                  .getTrigger(CFG.eventsManager.createEvent_EditTriggerID)
                  .lConditions
         ...
         case 82:
            CFG.eventsManager
               ...
               .getTrigger(CFG.eventsManager.createEvent_EditTriggerID)
               .lConditions
               .add(new Event_Conditions_RecruitedArmy());
            CFG.eventsManager.createEvent_EditConditionID = CFG.eventsManager
                  .createScenarioEvents
                  .getTrigger(CFG.eventsManager.createEvent_EditTriggerID)
                  .lConditions
         ...
         case 83:
            CFG.eventsManager
               ...
               .getTrigger(CFG.eventsManager.createEvent_EditTriggerID)
               .lConditions
               .add(new Event_Conditions_RecruitedArmyLow());
            CFG.eventsManager.createEvent_EditConditionID = CFG.eventsManager
                  .createScenarioEvents
                  .getTrigger(CFG.eventsManager.createEvent_EditTriggerID)
                  .lConditions
            ...
            break;
         case 84:
            CFG.eventsManager.createScenarioEvents.getTrigger(CFG.eventsManager.createEvent_EditTriggerID).lConditions.add(new Event_Conditions_Stability());
            CFG.eventsManager.createEvent_EditConditionID = CFG.eventsManager
                  .createScenarioEvents
                  .getTrigger(CFG.eventsManager.createEvent_EditTriggerID)
                  .lConditions
            ...
            break;
         case 85:
            CFG.eventsManager.createScenarioEvents.getTrigger(CFG.eventsManager.createEvent_EditTriggerID).lConditions.add(new Event_Conditions_StabilityLow());
            CFG.eventsManager.createEvent_EditConditionID = CFG.eventsManager
                  .createScenarioEvents
                  .getTrigger(CFG.eventsManager.createEvent_EditTriggerID)
                  .lConditions
            ...
            break;
         case 86:
            CFG.eventsManager.createScenarioEvents.getTrigger(CFG.eventsManager.createEvent_EditTriggerID).lConditions.add(new Event_Conditions_AveDev());
            CFG.eventsManager.createEvent_EditConditionID = CFG.eventsManager
                  .createScenarioEvents
                  .getTrigger(CFG.eventsManager.createEvent_EditTriggerID)
                  .lConditions
            ...
            break;
         case 87:
            CFG.eventsManager.createScenarioEvents.getTrigger(CFG.eventsManager.createEvent_EditTriggerID).lConditions.add(new Event_Conditions_AveDevLow());
            CFG.eventsManager.createEvent_EditConditionID = CFG.eventsManager
                  .createScenarioEvents
                  .getTrigger(CFG.eventsManager.createEvent_EditTriggerID)
                  .lConditions
            ...
            break;
         case 88:
            CFG.eventsManager.createScenarioEvents.getTrigger(CFG.eventsManager.createEvent_EditTriggerID).lConditions.add(new Event_Conditions_BForts());
            CFG.eventsManager.createEvent_EditConditionID = CFG.eventsManager
                  .createScenarioEvents
                  .getTrigger(CFG.eventsManager.createEvent_EditTriggerID)
                  .lConditions
            ...
            break;
         case 89:
            CFG.eventsManager.createScenarioEvents.getTrigger(CFG.eventsManager.createEvent_EditTriggerID).lConditions.add(new Event_Conditions_BTowers());
            CFG.eventsManager.createEvent_EditConditionID = CFG.eventsManager
                  .createScenarioEvents
                  .getTrigger(CFG.eventsManager.createEvent_EditTriggerID)
                  .lConditions
            ...
            break;
         case 90:
            CFG.eventsManager.createScenarioEvents.getTrigger(CFG.eventsManager.createEvent_EditTriggerID).lConditions.add(new Event_Conditions_BPorts());
            CFG.eventsManager.createEvent_EditConditionID = CFG.eventsManager
                  .createScenarioEvents
                  .getTrigger(CFG.eventsManager.createEvent_EditTriggerID)
                  .lConditions
            ...
            break;
         case 91:
            CFG.eventsManager.createScenarioEvents.getTrigger(CFG.eventsManager.createEvent_EditTriggerID).lConditions.add(new Event_Conditions_BFarms());
            CFG.eventsManager.createEvent_EditConditionID = CFG.eventsManager
                  .createScenarioEvents
                  .getTrigger(CFG.eventsManager.createEvent_EditTriggerID)
                  .lConditions
            ...
            break;
         case 92:
            CFG.eventsManager.createScenarioEvents.getTrigger(CFG.eventsManager.createEvent_EditTriggerID).lConditions.add(new Event_Conditions_BWorkshops());
            CFG.eventsManager.createEvent_EditConditionID = CFG.eventsManager
                  .createScenarioEvents
                  .getTrigger(CFG.eventsManager.createEvent_EditTriggerID)
                  .lConditions
            ...
            break;
         case 93:
            CFG.eventsManager.createScenarioEvents.getTrigger(CFG.eventsManager.createEvent_EditTriggerID).lConditions.add(new Event_Conditions_BLibraries());
            CFG.eventsManager.createEvent_EditConditionID = CFG.eventsManager
                  .createScenarioEvents
                  .getTrigger(CFG.eventsManager.createEvent_EditTriggerID)
                  .lConditions
            ...
            break;
         case 94:
            CFG.eventsManager.createScenarioEvents.getTrigger(CFG.eventsManager.createEvent_EditTriggerID).lConditions.add(new Event_Conditions_BArmories());
            CFG.eventsManager.createEvent_EditConditionID = CFG.eventsManager
                  .createScenarioEvents
                  .getTrigger(CFG.eventsManager.createEvent_EditTriggerID)
                  .lConditions
            ...
            break;
         case 95:
            CFG.eventsManager.createScenarioEvents.getTrigger(CFG.eventsManager.createEvent_EditTriggerID).lConditions.add(new Event_Conditions_BSupply());
            CFG.eventsManager.createEvent_EditConditionID = CFG.eventsManager
                  .createScenarioEvents
                  .getTrigger(CFG.eventsManager.createEvent_EditTriggerID)
                  .lConditions
            ...
            break;
         case 96:
            CFG.eventsManager.createScenarioEvents.getTrigger(CFG.eventsManager.createEvent_EditTriggerID).lConditions.add(new Event_Conditions_BMarket());
            CFG.eventsManager.createEvent_EditConditionID = CFG.eventsManager
                  .createScenarioEvents
                  .getTrigger(CFG.eventsManager.createEvent_EditTriggerID)
                  .lConditions
